...
PLUGIN.DefaultClothesMale = {
    ["torso"] = {
        ["bmModel"] = "models/tnb/halflife2/male_torso_citizen1.mdl",
        ["bmSkin"] = 0
    },
    ["legs"] = {
        ["bmModel"] = "models/tnb/halflife2/male_legs_citizen.mdl",
        ["bmSkin"] = 0
    }
}

PLUGIN.DefaultClothesFemale = {
    ["torso"] = {
        ["bmModel"] = "models/tnb/halflife2/female_torso_citizen1.mdl",
        ["bmSkin"] = 0 
    },
    ["legs"] = {
        ["bmModel"] = "models/tnb/halflife2/female_legs_citizen.mdl",
        ["bmSkin"] = 0 
    }
}
...
function PLUGIN:PlayerSpawn(client, curChar, prevChar)
    if client:GetCharacter() ~= nil then
        if string.find(client:GetCharacter():GetModel(), "models/tnb/techcom/") then
            local defaultclothes = !client:IsFemale() and self.DefaultClothesMale or self.DefaultClothesFemale
